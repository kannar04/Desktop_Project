using System;
// Thực thể dữ liệu ánh xạ bảng tài liệu học tập trong cơ sở dữ liệu
// Chức năng:
...
namespace DesktopApp_Project.DAL
{
    ...
    // Lớp thực thể dữ liệu ánh xạ dữ liệu tài liệu học tập từ bảng cơ sở dữ liệu sang đối tượng C#.
