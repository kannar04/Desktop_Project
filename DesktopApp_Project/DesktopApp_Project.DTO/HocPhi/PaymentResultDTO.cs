// Đối tượng truyền dữ liệu kết quả thanh toán
// Chức năng:
...
{
    // Lớp đối tượng truyền dữ liệu dùng để truyền dữ liệu kết quả thanh toán giữa các tầng giao diện, tầng nghiệp vụ và tầng dữ liệu.
