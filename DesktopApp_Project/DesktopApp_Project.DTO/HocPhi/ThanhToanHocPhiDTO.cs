using System;
// Đối tượng truyền dữ liệu thanh toán học phí
// Chức năng:
...
{
    // Lớp đối tượng truyền dữ liệu dùng để truyền dữ liệu thanh toán học phí giữa các tầng giao diện, tầng nghiệp vụ và tầng dữ liệu.
